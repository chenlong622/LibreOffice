...
CPPUNIT_TEST_FIXTURE(ThemeTest, testExplicitShapeColorsRoundtrip)
{
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(1), pFill->count());
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(1), pLine->count());
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(1), pThemed->count());
    CPPUNIT_ASSERT_EQUAL(u"accent2"_ustr, pThemed->attribute("val"));
    CPPUNIT_ASSERT_EQUAL(sal_Int32(0), pThemed->at(0)->countChildren());

    auto pShaded = aPath.create("/p:sld/p:cSld/p:spTree/p:sp[3]/p:spPr/a:solidFill/a:schemeClr");
    CPPUNIT_ASSERT_EQUAL(sal_Int32(1), pShaded->count());
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int32(1), pLumMod->count());
